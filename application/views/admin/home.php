...
<div class="row">
   <div class="twelve columns">
     ...
     <p>An easy to use Restaurant Website Software. You are currently logged in as <?php echo  $this->session->userdata('username'); ?>.</p>
     <hr />
   </div>
 </div>
  ...
  <div class="row">
	...
	<a href="<?php echo base_url();?>admin/products">View All Products</a><br />
	<a href="<?php echo base_url();?>admin/categories">View All Categories</a>
